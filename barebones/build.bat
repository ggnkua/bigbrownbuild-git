...
set GCCPATH=c:\msys64\home\ggn\brown
set GPP=%GCCPATH%\bin\m68k-atarisuperlativebrowner-elf-g++
set GCC=%GCCPATH%\bin\m68k-atarisuperlativebrowner-elf-gcc
...
for %%I in (%GASFILES%) do call :checkrun "obj\%%I.o" "%%I.gas" "%GCCPATH%\bin\m68k-atarisuperlativebrowner-elf-as -o obj\%%I.o %%I.gas"
