...
set GPP=%GCCPATH%\bin\m68k-atariextrabrowner-elf-g++
set GCC=%GCCPATH%\bin\m68k-atariextrabrowner-elf-gcc
...
for %%I in (%GASFILES%) do call :checkrun "obj\%%I.o" "%%I.gas" "%GCCPATH%\bin\m68k-atariextrabrowner-elf-as -o obj\%%I.o %%I.gas"
