...
mainbrown()
{
    ...
    if [ "$CROSS_COMPILING" == "1" ]; then
        ...
        export CROSS_PATH=
        if [ "$BUILD_14_2_0" != "0" ]; then export CROSS_PATH=$HOME/brown-crosstemp-14.2.0/m68k-atarisubliminalbrowner-elf/include/c++/14.2.0; fi
    ...
    if [ "$CLEANUP" == "Y" ] || [ "$CLEANUP" == "y" ]; then
        ...
        if [ "$BUILD_16_1_0" == "1" ]; then rm -rf binutils-2.46.0; fi
        if [ "$BUILD_16_2_0" == "1" ] || [ "$BUILD_TRUNK" == "1" ]; then rm -rf binutils-2.47; fi
    ...
    if [ "$REPLY" == "Y" ] || [ "$REPLY" == "y" ]; then
        if [ "$CLEANUP" == "Y" ]; then
            ...
            if [ "$BUILD_15_2_0" == "1" ]; then rm -rf gcc-15.2.0; fi
            if [ "$BUILD_16_1_0" == "1" ]; then rm -rf gcc-16.1.0; fi
            if [ "$BUILD_16_2_0" == "1" ]; then rm -rf gcc-16.2.0; fi
        fi    
        ...
        if [ "$BUILD_15_2_0" == "1" ]; then tar -Jxf gcc-15.2.0.tar.xz; fi
        if [ "$BUILD_16_1_0" == "1" ]; then tar -Jxf gcc-16.1.0.tar.xz; fi
        if [ "$BUILD_16_2_0" == "1" ]; then tar -Jxf gcc-16.2.0.tar.xz; fi
        ...
        if [ "$GLOBAL_DOWNLOAD_PREREQUISITES" == "1" ]; then
            ...
            if [ "$BUILD_15_2_0" == "1" ]; then cd gcc-15.2.0;./contrib/download_prerequisites &> prerequisites.log;cd "$HOMEDIR"; fi
            if [ "$BUILD_16_1_0" == "1" ]; then cd gcc-16.1.0;./contrib/download_prerequisites &> prerequisites.log;cd "$HOMEDIR"; fi
            if [ "$BUILD_16_2_0" == "1" ]; then cd gcc-16.2.0;./contrib/download_prerequisites &> prerequisites.log;cd "$HOMEDIR"; fi
    ...
    if [ "$BUILD_NEWLIB" != "0" ]; then tar -zxf newlib-4.1.0.tar.gz; fi
        ...
        if [ "$BUILD_15_1_0" == "1" ]; then tar -Jxf binutils-2.44.tar.xz; fi
        if [ "$BUILD_15_2_0" == "1" ]; then tar -Jxf binutils-2.45.tar.xz; fi
        if [ "$BUILD_16_1_0" == "1" ]; then 
            # It seems that Nick made a small error when packaging 2.46 and added a .0
            # in the version number, so it's 2.46.0 in the official archives.
            # https://sourceware.org/pipermail/binutils/2026-February/148185.html
            # What are we supposed to do? Kill him (joking)? Of course not,
            # let's just rename the folder post decompression
            tar -Jxf binutils-2.46.0.tar.xz; 
            mv binutils-2.46.0 binutils-2.46
        fi
        if [ "$BUILD_16_2_0" == "1" ] || [ "$BUILD_TRUNK" == "1" ]; then tar -Jxf binutils-2.47.tar.xz; fi
    fi
    ...
    BINUTILS=2.45
    if [ "$BUILD_15_2_0" == "1" ]; then buildgcc 15.2.0; fi

    BINUTILS=2.46
    if [ "$BUILD_16_1_0" == "1" ]; then buildgcc 16.1.0; fi
    BINUTILS=2.47
    if [ "$BUILD_16_2_0" == "1" ]; then buildgcc 16.2.0; fi
...
buildgcc()
{
    ...
    15.2.0)   VENDOR=atarisuperlativebrowner;;
    16.1.0)   VENDOR=atariexaltedbrown;;
    16.2.0)   VENDOR=atariexaltedbrowner;;
    ...
    if [ "$BUILD_MINTLIB" != "0" ]; then
        ...
        if [ "$REPLY" == "Y" ] || [ "$REPLY" == "y" ]; then
            ...
            if [ "$1" == "TRUNK" ] || [ "$1" == "10.1.0" ] || [ "$1" == "10.2.0" ] || [ "$1" == "10.3.0" ] || [ "$1" == "11.1.0" ] || [ "$1" == "11.2.0" ] || [ "$1" == "12.1.0" ] || [ "$1" == "12.2.0" ] || [ "$1" == "13.1.0" ] || [ "$1" == "13.2.0" ] || [ "$1" == "14.1.0" ] || [ "$1" == "14.2.0" ] || [ "$1" == "15.1.0" ] || [ "$1" == "15.2.0" ] || [ "$1" == "16.1.0" ] || [ "$1" == "16.2.0" ]; then
    ...
    if [ "$REPLY" == "Y" ] || [ "$REPLY" == "y" ]; then
        ...
        if [ "$1" == "10.3.0" ] || [ "$1" == "11.1.0" ] || [ "$1" == "11.2.0" ] || [ "$1" == "12.1.0" ] || [ "$1" == "12.2.0" ] || [ "$1" == "13.1.0" ] || [ "$1" == "13.2.0" ] || [ "$1" == "14.1.0" ] || [ "$1" == "14.2.0" ] || [ "$1" == "15.1.0" ]  || [ "$1" == "15.2.0" ] || [ "$1" == "16.1.0" ] || [ "$1" == "16.2.0" ] || [ "$1" == "TRUNK" ]; then
        ...
        if [ "$1" == "11.1.0" ] || [ "$1" == "11.2.0" ] || [ "$1" == "12.1.0" ] || [ "$1" == "12.2.0" ] || [ "$1" == "13.1.0" ] || [ "$1" == "13.2.0" ] || [ "$1" == "14.1.0" ] || [ "$1" == "14.2.0" ] || [ "$1" == "15.1.0" ]  || [ "$1" == "15.2.0" ] || [ "$1" == "16.1.0" ] || [ "$1" == "16.2.0" ] || [ "$1" == "TRUNK" ]; then
        ...
        # Seems that gcc 9.1.0 (or the underlying system) also doesn't know what ENOTSUP is, which also cascades to std::errc::not_supported
        ...
        if [ "$1" == "9.1.0" ] || [ "$1" == "9.2.0" ] || [ "$1" == "9.3.0" ] || [ "$1" == "10.1.0" ] || [ "$1" == "10.2.0" ] || [ "$1" == "10.3.0" ] || [ "$1" == "11.1.0" ] || [ "$1" == "11.2.0" ] || [ "$1" == "12.1.0" ] || [ "$1" == "12.2.0" ]  || [ "$1" == "13.1.0" ] || [ "$1" == "13.2.0" ] || [ "$1" == "14.1.0" ] || [ "$1" == "14.2.0" ] || [ "$1" == "15.1.0" ] || [ "$1" == "15.2.0" ] || [ "$1" == "16.1.0" ] || [ "$1" == "16.2.0" ] || [ "$1" == "TRUNK" ]; then
...
#        fi
    ...
    if [ "$REPLY" == "Y" ] || [ "$REPLY" == "y" ]; then
        ...
        if [ "$1" == "12.1.0" ] || [ "$1" == "12.2.0" ]  || [ "$1" == "13.1.0" ] || [ "$1" == "13.2.0" ] || [ "$1" == "14.1.0" ] || [ "$1" == "14.2.0" ] || [ "$1" == "15.1.0" ] || [ "$1" == "15.2.0" ] || [ "$1" == "16.1.0" ] || [ "$1" == "16.2.0" ] || [ "$1" == "TRUNK" ]; then
    ...
    if [ "$BUILD_FORTRAN" == "1" ]; then
        if [ "$CROSS_COMPILING" != "0" ]; then
            ...
            if [ "$REPLY" == "Y" ] || [ "$REPLY" == "y" ]; then
                ...
                if [ "$1" == "9.2.0" ] || [ "$1" == "9.3.0" ] || [ "$1" == "10.1.0" ] || [ "$1" == "10.2.0" ] || [ "$1" == "10.3.0" ] || [ "$1" == "11.1.0" ] || [ "$1" == "11.2.0" ] || [ "$1" == "12.1.0" ] || [ "$1" == "12.2.0" ]  || [ "$1" == "13.1.0" ] || [ "$1" == "13.2.0" ] || [ "$1" == "14.1.0" ] || [ "$1" == "14.2.0" ] || [ "$1" == "15.1.0" ] || [ "$1" == "15.2.0" ] || [ "$1" == "16.1.0" ] || [ "$1" == "16.2.0" ] || [ "$1" == "TRUNK" ]; then
    ...
    if [ "$REPLY" == "Y" ] || [ "$REPLY" == "y" ]; then
        ...
        if [ "$BUILD_14_2_0" != "0" ]; then
            ...
            export CPATH=$HOME/brown-crosstemp-14.2.0/m68k-atarisubliminalbrowner-elf/include/c++/14.2.0
        fi
        if [ "$BUILD_15_1_0" != "0" ]; then
            export CPATH=$HOME/brown-crosstemp-15.1.0/m68k-atarisuperlativebrown-elf/include/c++/15.1.0
        fi
        if [ "$1" == "15.2.0" ]; then
            export CPATH=$HOME/brown-crosstemp-15.2.0/m68k-atarisuperlativebrowner-elf/include/c++/15.2.0
        fi
        if [ "$1" == "16.1.0" ]; then
            # There's probably something broken with the above. floating_from_chars.cc and floating_to_chars.cc have not changed at all since 15.2.0, and yet
            ...
            #echo PATH=$PATH
            export CPATH=$HOME/bigbrownbuild-git/build-gcc-16.1.0/m68k-atariexaltedbrown-elf/libstdc++-v3/include
